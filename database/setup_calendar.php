...
if ($conn->multi_query($drop_tables)) {
    // Wait for the first query to complete
    while ($conn->more_results() && $conn->next_result());
    
    // Now execute the create tables query
    if ($conn->multi_query($create_tables)) {
        echo "Calendar tables created successfully!<br>";
        echo "The following tables have been created:<br>";
        echo "- facilities<br>";
        echo "- bookings<br>";
        echo "<br>Sample facilities have been added:<br>";
        echo "- Gymnasium<br>";
        echo "- Swimming Pool<br>";
        echo "- Tennis Court<br>";
        echo "- Basketball Court<br>";
        echo "- Conference Room<br>";
    } else {
        echo "Error creating tables: " . $conn->error;
    }
} else {
    echo "Error dropping existing tables: " . $conn->error;
}
